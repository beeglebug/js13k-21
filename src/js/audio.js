...
// sounds generated by https://killedbyapixel.github.io/ZzFX/
let soundHit = zzfxG(...[2.41,,271,,,.21,4,2.88,3.1,,,,.07,.1,,.3,.1,.55,.04,.16]);
let soundShoot = zzfxG(...[2.04,,477,0,.09,.01,1,1.6,-3.6,,,,.08,.7,,,.1,.95]);
let soundEnemyShoot = zzfxG(...[1.01,,394,.01,.06,0,,1.69,-7.8,,,,,,,,,.98]); // 
let soundPlayerDie = zzfxG(...[1.97,,992,.01,.18,.87,3,4.91,,.5,,,,.6,-5.2,.6,.46,.75,.02]);
